...
const ViewFeedback = () => {
  ...
  const [sectionStudents, setSectionStudents] = useState([]); // New state for students in the section
  const [selectedStudentEmail, setSelectedStudentEmail] = useState(null); // New state for selected student
  ...
  useEffect(() => {
    const fetchCheckInData = async () => {
      ...
      try {
        ...
        // Extract unique student emails from groups for the sectionStudents state
  ...
  // Function to load student options for AsyncSelect
